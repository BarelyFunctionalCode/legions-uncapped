...
public partial class @PlayerControls : IInputActionCollection2, IDisposable
{
    ...
    public struct EquipmentActions
    {
        ...
        public void SetCallbacks(IEquipmentActions instance)
        {
            ...
            {
                @PrimaryFire.started -= m_Wrapper.m_EquipmentActionsCallbackInterface.OnPrimaryFire;
                @PrimaryFire.performed -= m_Wrapper.m_EquipmentActionsCallbackInterface.OnPrimaryFire;
                @PrimaryFire.canceled -= m_Wrapper.m_EquipmentActionsCallbackInterface.OnPrimaryFire;
                @NextWeapon.started -= m_Wrapper.m_EquipmentActionsCallbackInterface.OnNextWeapon;
                @NextWeapon.performed -= m_Wrapper.m_EquipmentActionsCallbackInterface.OnNextWeapon;
                @NextWeapon.canceled -= m_Wrapper.m_EquipmentActionsCallbackInterface.OnNextWeapon;
                @PreviousWeapon.started -= m_Wrapper.m_EquipmentActionsCallbackInterface.OnPreviousWeapon;
                @PreviousWeapon.performed -= m_Wrapper.m_EquipmentActionsCallbackInterface.OnPreviousWeapon;
                @PreviousWeapon.canceled -= m_Wrapper.m_EquipmentActionsCallbackInterface.OnPreviousWeapon;
                @Throwable.started -= m_Wrapper.m_EquipmentActionsCallbackInterface.OnThrowable;
                @Throwable.performed -= m_Wrapper.m_EquipmentActionsCallbackInterface.OnThrowable;
                @Throwable.canceled -= m_Wrapper.m_EquipmentActionsCallbackInterface.OnThrowable;
            }
